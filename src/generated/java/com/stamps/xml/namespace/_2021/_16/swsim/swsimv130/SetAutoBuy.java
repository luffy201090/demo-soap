 ...
 *         &lt;/choice&gt;
 *         &lt;element name="AutoBuySettings" type="{http://stamps.com/xml/namespace/2021/16/swsim/SwsimV130}AutoBuySettings"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SetAutoBuy")
public class SetAutoBuy {

    @XmlElement(name = "Authenticator")
    protected String authenticator;
    @XmlElement(name = "Credentials")
    protected Credentials credentials;
    @XmlElement(name = "AutoBuySettings", required = true)
